...
async def update_task(user: UserSchema, task_description: str):
    return TaskRepository().finish_user_task(telegram_user_id=user.telegram_id, task_description=task_description)
